...
CREATE TABLE `materia` (
  ...
  `periodo` INT NOT NULL, -- 0 = OPTATIVA
...
('G03ACEL2.01', 'ANÁLISE DE CIRCUITOS ELÉTRICOS II', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 1),
...
('G03BDIC0.02', 'BANCO DE DADOS PARA INTERNET DAS COISAS', '45h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 2),
('G03C SPEC1.01', 'CONTEXTO SOCIAL E PROFISSIONAL DA ENGENHARIA DA COMPUTAÇÃO', '30h', NULL, NULL, 1, NULL, '', 'Componente Placeholder', 3),
('G03CAUT1.02', 'CONTROLE AUTOMÁTICO I', '90h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 3),
('G03CAUT2.02', 'CONTROLE AUTOMÁTICO II', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 4),
('G03CEVO0.02', 'COMPUTAÇÃO EVOLUCIONISTA', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 5),
('G03CFVC0.01', 'CÁLCULO COM FUNÇÕES DE UMA VARIÁVEL COMPLEXA', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 6),
...
('G03CGRA0.02', 'COMPUTAÇÃO GRÁFICA', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 7),
('G03COMP0.02', 'COMPILADORES', '60h', NULL, NULL, 8, NULL, '', 'Componente Placeholder', 1),
('G03DASI0.01', 'DESENVOLVIMENTO ÁGIL DE SISTEMAS', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 1),
...
('G03EAAU0.01', 'ECONOMIA APLICADA À AUTOMAÇÃO', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 2),
('G03EAPR0.01', 'ELETRÔNICA APLICADA A PROJETOS', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 3),
...
('G03EDPA0.01', 'EQUAÇÕES DIFERENCIAIS PARCIAIS', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 4),
('G03ELET1.01', 'ELETRÔNICA I', '60h', NULL, NULL, 5, NULL, '', 'Componente Placeholder', 1),
('G03ELET2.01', 'ELETRÔNICA II', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 5),
('G03EMNE0.01', 'EMPREENDEDORISMO E MODELO DE NEGÓCIOS', '30h', NULL, NULL, 8, NULL, '', 'Componente Placeholder', 2),
('G03EPOT0.01', 'ELETRÔNICA DE POTÊNCIA', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 6),
...
('G03FAGRO0.01', 'FUNDAMENTOS DO AGRONEGÓCIO', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 7),
...
('G03FFMO0.01', 'FUNDAMENTOS DE FÍSICA MODERNA', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 1),
...
('G03FSSI0.01', 'FUNDAMENTOS DE SINAIS E SISTEMAS', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 2),
...
('G03IADM0.01', 'INTRODUÇÃO À ADMINISTRAÇÃO', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 3),
('G03IART0.02', 'INTELIGÊNCIA ARTIFICIAL', '60h', NULL, NULL, 8, NULL, '', 'Componente Placeholder', 4),
('G03IDIR0.02', 'INTRODUÇÃO AO DIREITO', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 4),
('G03IEECO.01', 'INTRODUÇÃO À EXPERIMENTAÇÃO EM ENGENHARIA DA COMPUTAÇÃO', '30h', NULL, NULL, 1, NULL, '', 'Componente Placeholder', 5),
('G03IESE0.02', 'INTRODUÇÃO À ENGENHARIA DE SEGURANÇA', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 5),
('G03IICO0.02', 'INTRODUÇÃO À INTERNET DAS COISAS', '45h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 6),
('G03IIND0.02', 'INSTRUMENTAÇÃO INDUSTRIAL', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 7),
('G03IINS2.01', 'INGLÊS INSTRUMENTAL II', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 1),
...
('G03LCAU1.01', 'LABORATÓRIO DE CONTROLE AUTOMÁTICO I', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 2),
('G03LCAU2.01', 'LABORATÓRIO DE CONTROLE AUTOMÁTICO II', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 3),
...
('G03LEPO0.01', 'LABORATÓRIO DE ELETRÔNICA DE POTÊNCIA', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 4),
('G03LFAU0.02', 'LINGUAGENS FORMAIS E AUTÔMATOS', '60h', NULL, NULL, 6, NULL, '', 'Componente Placeholder', 2),
('G03LIBR1.02', 'LIBRAS I', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 5),
('G03LIBR2.02', 'LIBRAS II', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 6),
('G03LIIN0.01', 'LABORATÓRIO DE INSTRUMENTAÇÃO INDUSTRIAL', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 7),
('G03LPRO0.02', 'LINGUAGENS DE PROGRAMAÇÃO', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 1),
('G03LPSE0.01', 'LABORATÓRIO DE PROGRAMAÇÃO DE SISTEMAS EMBARCADOS', '30h', NULL, NULL, 8, NULL, '', 'Componente Placeholder', 5),
('G03LQUI0.01', 'LABORATÓRIO DE QUÍMICA', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 2),
...
('G03MADE0.02', 'MODELAGEM E AVALIAÇÃO DE DESEMPENHO', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 3),
('G03MCCE0.01', 'MODELAGEM E CONTROLE DE CONVERSORES ESTÁTICOS', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 4),
...
('G03MELE0.01', 'MATERIAIS ELÉTRICOS', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 5),
('G03MNUM1.02', 'MÉTODOS NUMÉRICOS I', '60h', NULL, NULL, 5, NULL, '', 'Componente Placeholder', 5),
('G03MNUM2.02', 'MÉTODOS NUMÉRICOS II', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 6),
('G03MPEC0.01', 'METODOLOGIA DA PESQUISA - ENG COMPUTAÇÃO - LP', '30h', NULL, NULL, 9, NULL, '', 'Componente Placeholder', 1),
('G03NQIN0.01', 'NORMALIZAÇÃO E QUALIDADE INDUSTRIAL', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 7),
('G03OCOM0.02', 'ORGANIZAÇÃO DE COMPUTADORES', '60h', NULL, NULL, 6, NULL, '', 'Componente Placeholder', 4),
('G03OEMP0.01', 'ORGANIZAÇÃO EMPRESARIAL', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 1),
('G03PAOR0.01', 'PSICOLOGIA APLICADA ÀS ORGANIZAÇÕES', '30h', NULL, NULL, 8, NULL, '', 'Componente Placeholder', 6),
('G03PDIM0.02', 'PROCESSAMENTO DIGITAL DE IMAGENS', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 2),
...
('G03POPE0.02', 'PESQUISA OPERACIONAL', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 3),
('G03PSEM0.01', 'PROGRAMAÇÃO DE SISTEMAS EMBARCADOS', '30h', NULL, NULL, 8, NULL, '', 'Componente Placeholder', 7),
('G03QUIM0.01', 'QUÍMICA', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 4),
('G03RCOMP0.03', 'REDES DE COMPUTADORES', '60h', NULL, NULL, 6, NULL, '', 'Componente Placeholder', 6),
('G03RNAR0.02', 'REDES NEURAIS ARTIFICIAIS', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 5),
('G03RSSF0.02', 'REDES DE SENSORES SEM FIO', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 6),
...
('G03SOPE2.03', 'SISTEMAS OPERACIONAIS II', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 7),
...
('G08IECO0.01', 'INTRODUÇÃO À ECONOMIA', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 1),
('GT03ELE003.1', 'TÓPICOS ESPECIAIS EM ELETRÔNICA: PROJETOS MICROCONTROLADOS COM INTERFACE DE REDE DE DADOS WIFI E ETHERNET', '30h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 2),
('GT03FEC001.1', 'TÓPICOS ESPECIAIS EM FUNDAMENTOS DE ENGENHARIA DE COMPUTAÇÃO: PROGRAMAÇÃO COMPETITIVA', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 3),
('GT03LEI003.1', 'TÓPICOS ESPECIAIS EM LINGUAGENS DE PROGRAMAÇÃO: DESENVOLVIMENTO DE APLICAÇÕES PARA AMBIENTES MOBILE E WEB', '60h', NULL, NULL, 0, NULL, '', 'Componente Placeholder', 4);
